...
import me.voguh.unichat.adapter.client.gui.chat.image.ImageTexture;
import me.voguh.unichat.adapter.client.gui.chat.image.ImageTextures;
...
public final class MessageComposer {
    ...
    private static void append(MutableComponent body, MessageSegment segment) {
        switch (segment) {
            ...
            case MessageSegment.Image image ->
                body.append(imageOrCode(image.code(), image.url(), ImageFont.Kind.EMOTE));
        }
    }
